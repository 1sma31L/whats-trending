			...
			<AnimatedDiv id={0} className="text-[12px] sm:text-[14px]">
				<div className="flex flex-col gap-2 w-full">
					<div className="my-2">
						...
						<p className="text-zinc-500 dark:text-zinc-400 text-[12px] md:text-[14px] indent-2">
					...
					<div className="py-2">
						...
						<p className="text-zinc-500 text-[12px] md:text-[14px] dark:text-zinc-400 indent-2">
