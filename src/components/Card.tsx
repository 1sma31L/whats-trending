...
async function Card({
	...
	return (
		<div className="flex flex-row min-h-[150px] gap-1 my-4 border rounded-md md:rounded-xl  xl:hover:translate-x-2 overflow-hidden transition-all duration-300 dark:border-zinc-800">
			<img
				src={poster_path}
				alt=""
